...
<body>
	...
	<h1 style="color: red; font-size: 50px;" align="center">Congratulations DevOps Team!</h1>
	<h2 style="color: red;font-size: 30px" align="center">Your web application is successfully deployed</h2>
	<h2 style="color: red;font-size: 20px" align="center">By ATL PS Team, Bangalore</h2>
</body>
</html>
